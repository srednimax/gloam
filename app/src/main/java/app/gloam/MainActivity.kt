...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // **Nothing is decided here about which surface the user wanted.** The icon's intent names
        // `ControlsActivity`, so a tap that should open the compact controls never reaches this
        // Activity at all — `docs/phase-3.md` §2, shape iv, and the manifest carries why a forward
        // from here could not do it.
